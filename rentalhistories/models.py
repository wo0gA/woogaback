...
class RentalHistory(BaseModel):
    ...
    renter = models.ForeignKey(User, verbose_name='대여자', related_name='rentalhistories', on_delete=models.CASCADE)
    owner = models.ForeignKey(User, verbose_name='대여자', related_name='rentalhistories', on_delete=models.CASCADE)
